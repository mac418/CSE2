 ...
 *    The program has a division between doubles which causes the rounding to
 *    not match the expected outcome for when the user enters 7, 41 and 33
 *    thus skipping the printing part and ending the program.
 * 
 */
